...
大的内容方向和 v1.0 后路线，以 `docs/CONTENT_ROADMAP.md` 为准。`v1.0 Chapter 1《都市怪谈篇》` 是黑客松提交版，不是项目内容终点；后续可扩展《赌局篇》《电子世界篇》等章节。
...
> 注意：从下方第 1 章开始，大量内容是早期 46 小时方案和历史设计留档。旧关卡名只代表历史方案，不代表当前提交版。当前提交版是 v1.0 Chapter 1《都市怪谈篇》，关卡展示名是 L1《断桥回声》、L2《314号档案》、L3《最后的社团室》。
